...
true_tables <- c("patient", "hospitalization", "vitals", "labs", 
                 "microbiology_culture", "medication_admin_continuous", "adt", "respiratory_support")
...
```{r}
# q: I want to save all the filter tables in one Rdata file
